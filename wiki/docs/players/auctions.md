...
This shows all active auctions with stall IDs, current high bids, and time remaining.
...
Your bid must exceed the current high bid. Bids are **final** — you cannot undo a bid.
